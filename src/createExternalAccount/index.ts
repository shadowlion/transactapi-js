 ...
 * @param {string} Is this for an Account or Issuer Account?
 * @param {number} accountId/issuerId - Account ID or Issuer ID that is generated by the API when an Account(createAccount) or Issuer(createIssuer) is created.
